...
const Education = ({ id }) => {
  return (
    <section
      id={id}
      className="bg-[#FFFFFF] flex flex-col justify-center w-full items-center pb-[70px] max-md:pb-[30px] max-md:w-full"
    >
      ...
      <div className="flex flex-row sm:space-x-[20px] max-md:space-x-[5px] items-center mt-[14px] max-md:mt-[5px] justify-center">
        <FaGraduationCap className="h-[36px] w-[42px] max-md:w-[30px] max-md:h-[30px] max-md:pb-[6px] text-custom-purple pt-[5px]" />
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <motion.div className="absolute z-20 flex flex-row space-x-[20px] mt-[40px] max-md:mt-[20px] ml-[520px] max-md:space-x-[5px] max-md:ml-[176px]">
          <motion.div className="border-custom-purple border-[4px] max-md:w-[15px] h-[30px] shadow-custom flex justify-center max-md:h-[15px] max-md:border-[2px] items-center bg-white rounded-full w-[30px] ">
            <FaGraduationCap className="h-[15px] w-[15px] max-md:h-[7.5px] max-md:w-[7.5px]" />
          </motion.div>
